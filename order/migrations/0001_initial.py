# Generated by Django 3.1.7 on 2021-02-25 16:53
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('voucher', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='orders', to='voucher.voucher')),
            ],
            options={
                'db_table': 'Order',
                'ordering': ['-created'],
